...
Cucumber.prototype._conditionOutput = function (message) {
  ...
  try {
    ...
    _.each(message.split('\n'), function (line) {
      if (self.options.singleSnippetPerFile && self.options.singleSnippetPerFile !== 'false' && line.match(/this\./)) {
      ...
      if (self.options.singleSnippetPerFile && self.options.singleSnippetPerFile !== 'false' && line.match(/}\);/)) {
