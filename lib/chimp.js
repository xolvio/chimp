...
Chimp.prototype.selectMode = function (callback) {
  ...
  if (this.options.watch && this.options.watch !== 'false') {
    this.watch();
  } else if (this.options.server && this.options.server !== 'false') {
    this.server();
  } else {
    this.run(callback);
  }
...
Chimp.prototype.watch = function () {
  ...
  if (self.options.ddp && self.options.ddp !== 'false') {
...
Chimp.prototype._startServer = function (port) {
  ...
  if (this.options.ddp && this.options.ddp !== 'false') {
...
Chimp.prototype._createProcesses = function () {
  ...
  else if (!this.options.host && this.options.host !== 'false') {
    process.env['chimp.host'] = this.options.host = 'localhost';
    var selenium = new exports.Selenium(this.options);
    processes.push(selenium);
  }

  if (this.options.mocha && this.options.mocha !== 'false') {
    ...
    if (this.options.criticalSteps && this.options.criticalSteps !== 'false') {
