...
Monkey.prototype.watch = function () {
  ...
  watcher.on('ready', function () {
    ...
    log.info('[cuke-monkey][monkey] is watching your files');
    ...
    watcher.on('all', function (event, path) {
      ...
      log.debug('[cuke-monkey][monkey] file changed, running');
      self.rerun();
...
Monkey.prototype.run = function (callback) {
  ...
  log.info('[cuke-monkey][monkey] Cuke-monkey is running');
...
Monkey.prototype.interrupt = function (callback) {
  ...
  log.debug('[cuke-monkey][monkey] interrupting', self.processes.length, 'processes');
...
Monkey.prototype.rerun = function () {
  ...
  log.debug('[cuke-monkey][monkey] rerunnning');
