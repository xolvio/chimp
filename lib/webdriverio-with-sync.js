...
var wrapAsyncPromiseOnlyChainable = require('./fiber-utils').wrapAsyncPromiseOnlyChainable;
...
webdriverioWithSync.remote = function (options) {
  ...
  remote.addCommand = function (fnName, fn, forceOverwrite) {
    ...
    wrapAsyncObject(remote, [fnName], syncByDefault);
    return result;
  };
  ...
  ['protocol', 'commands'].forEach(function(commandType) {
    ...
    wrapAsyncObject(remote, commandNames, syncByDefault, wrapAsyncPromiseOnlyChainable);
  });
