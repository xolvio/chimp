...
var _configureRemote = function(webdriverOptions, remote, self, callback) {
  ...
  self._waitForConnection(browser, decideReuse);

};

SessionManager.prototype.multiremote = function(webdriverOptions, callback) {
  var _self = this;
  _configureRemote(webdriverOptions, this.webdriver.multiremote, _self, callback);
};
...
SessionManager.prototype.remote = function (webdriverOptions, callback) {
  var _self = this;
  _configureRemote(webdriverOptions, this.webdriver.remote, _self, callback);
};
