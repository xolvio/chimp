...
SessionManager.prototype.remote = function (webdriverOptions, callback) {
  ...
  //console.log("webdriverOptions", JSON.stringify(webdriverOptions));
  var _multiRemoteOptions = {
    browserA: webdriverOptions,
    browserB: webdriverOptions
  }


  //console.log("_multiRemoteOptions ", _multiRemoteOptions)
  var _newOptions = {
    browserA: {
      desiredCapabilities: {
        browserName: 'chrome'
  ...
  var matrix = this.webdriver.remote(_multiRemoteOptions);
  //var matrix = this.webdriver.remote(webdriverOptions);
  //var browser = matrix.select("browserA");
