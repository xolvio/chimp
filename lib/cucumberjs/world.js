...
module.exports = function () {
  ...
  this.World = function World (callback) {
    ...
    if (global.browser.browsers) {
      this.clients = global.browser.browsers;
      this.client = global.alice = global.Alice = global.browser.browsers[0];
      global.bob = global.Bob = global.browser.browsers[1];
    } else {
    ...
    global.browsers = global.browser.browsers;
    global.client = this.client;
    global.clients = this.clients;
