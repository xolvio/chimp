...
module.exports = function () {
  ...
  this.World = function World (callback) {
    ...
    if (this.client.select) {
      console.log("client has select!");
      this.client = global.browser.select("browserA");
      this.clientB = global.browser.select("browserB");
    } else {
      console.log("client doesnt have select")
    }
