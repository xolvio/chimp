module.exports = function () {
  ...
  this.registerHandler('BeforeFeatures', function (event, callback) {
    ...
    var setupBrowser = Promise.promisify(function (callback) {
      ...
      var configPath = path.resolve(process.cwd(), process.env['chimp.path'], 'monkey.js');
    ...
    var initBrowser = Promise.promisify(function (callback) {
      ...
      global.browser.init(function () {
        ...
        browser.on('error', function (event) {
          ...
          log.debug('[cuke-monkey][hooks] trying to handle browser error', event);
          ...
          log.error('[cuke-monkey][hooks] browser error', toThrow);
          throw toThrow;
        });
