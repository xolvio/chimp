  ...
  steps.forEach(function (step) {
    ...
    helper[step] = function (/* arguments */) {
      ...
      if (arguments.length) {
        ...
        arguments[lastArgumentIndex] = makeFunction(function (/* arguments */) {
          var context = this;
          ...
          Fiber(function () {
            ...
            var promise = stepDefinition.apply(context, args);
